...
export default function OwnerList({ 
  ...
  // ✅ CORRIGIDO: Ordenar alfabeticamente
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="flex items-center justify-between mb-8 flex-wrap gap-4">
            <div>
              ...
              {/* ✅ CORRIGIDO: Só mostra contagem quando NÃO está no formulário */}
              {!showForm && (
          ...
          {/* ✅ CORRIGIDO: Lista só aparece quando NÃO está no formulário */}
          {!showForm && (
            <>
                ...
                <>
                  ...
                  <div className="hidden lg:block bg-white rounded-xl border-2 border-gray-200 overflow-hidden">
                    ...
                    <div className="divide-y divide-gray-200">
                      {/* ✅ CORRIGIDO: Usa sortedOwners ao invés de owners */}
